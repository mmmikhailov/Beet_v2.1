...
beetlecoin-cli stop > /dev/null 2>&1
wget https://github.com/beetledev/Wallet/releases/download/v2.1/beetlecoind -O /usr/local/bin/beetlecoind
wget https://github.com/beetledev/Wallet/releases/download/v2.1/beetlecoin-cli -O /usr/local/bin/beetlecoin-cli
chmod +x /usr/local/bin/beetlecoin*
...
echo "rpcport=3134" >> $CONF_DIR/$CONF_FILE
